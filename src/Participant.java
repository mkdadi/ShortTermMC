...
public class Participant
{
    ...
    /**
     * To store values in the Participant Object
     * 
    ...
    /**
     * This method is to Delete a Participant
     * 
     * @param students phone number of the Participant to be deleted
     * @param course Course taken by the Participant to be deleted
     * @param length No of Participants previously present in the Course
     * @param option Student index in the /Data/Students/students.sdat file
     */
    ...
    /**
     * 
     * This method is to change details of a Participant
     * 
     * @param course Course name
     * @param student Student phone number as string
