...
public class Faculty
{
    ...
    /**
     * This method is to change faculty of the course
     * 
     * @param course Course Name of which faculty details have to be changed
     * @param faculty Phone number of the faculty that has to be changed
